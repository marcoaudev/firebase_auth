import 'package:auth/app/auth/data/datasources/user_auth_data_sources_impl.dart';
import 'package:auth/app/auth/data/repositories/user_repository_impl.dart';
import 'package:auth/app/auth/domain/usecases/sing_in_usecase.dart';
import 'package:auth/app/auth/ui/screens/components/button_service.dart';
...
import 'package:auth/app/auth/ui/stores/sign_in_page_store.dart';
import 'package:auth/app/home/home_page.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  SignInPageStore store = SignInPageStore(
    SignInUseCase(repository: UserRepositoryImpl(AuthUserDataSourceFirebase())),
  );
                  ...
                  child: SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Observer(
                          builder: (context) {
                            if (store.signInPageState.isSuccess) {
                              WidgetsBinding.instance.addPostFrameCallback((_) {
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (context) {
                                      return HomePage(user: store.user);
                                    },
                                  ),
                                );
                              });
                            ...
                            return CustomButton(
                              ...
                              child:
                                  store.signInPageState.isLoading
                                      ? SizedBox(
                                        height: 20,
                                        width: 20,
